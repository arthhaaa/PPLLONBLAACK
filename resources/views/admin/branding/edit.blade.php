                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_mitra" class="form-control @error('nama_mitra') is-invalid @enderror" value="{{ old('nama_mitra', $branding->nama_mitra) }}" required data-required-message="Label / Mitra wajib diisi.">
                            @error('nama_mitra')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_konten" class="form-control @error('nama_konten') is-invalid @enderror" value="{{ old('nama_konten', $branding->nama_konten) }}" required data-required-message="Judul Konten wajib diisi.">
                            @error('nama_konten')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @else
