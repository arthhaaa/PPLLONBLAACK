...
<main class="product-detail-page">
    <section class="product-archive-hero product-detail-hero customer-page-banner">
            ...
            <div class="product-detail-layout">
                ...
                <div class="detail-info">
                    ...
                    <div class="detail-title-row">
                        ...
                        <span class="detail-stock-pill {{ $stockClass }}">
                            {{ $stockLabel }}
                        </span>
                    </div>
                ...
                <section class="related-products-section">
                    ...
                    <div class="row g-4">
                        @foreach($relatedProducts as $related)
                            @php
                                $relatedStock = (int) $related->stok_produk;
                                $relatedStockClass = $relatedStock <= 0 ? 'is-empty' : ($relatedStock <= 10 ? 'is-low' : 'is-available');
                                $relatedStockLabel = $relatedStock <= 0 ? 'Out of Stock' : ($relatedStock <= 10 ? 'Low Stock' : 'In Stock');
                            @endphp
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a href="{{ route('customer.product.show', $related->id_produk) }}" class="related-card">
                                    ...
                                    <div class="related-body">
                                        <span class="related-stock-pill {{ $relatedStockClass }}">{{ $relatedStockLabel }}</span>
...
<style>
    ...
    .detail-stock-pill {
        ...
        box-shadow: 0 4px 12px rgba(36, 24, 19, 0.14);
        letter-spacing: 0.02em;
    }

    .detail-stock-pill.is-available,
    .related-stock-pill.is-available {
        background: #16794b;
        border-color: #16794b;
        color: #ffffff;
    }

    .detail-stock-pill.is-low,
    .related-stock-pill.is-low {
        background: #b85c00;
        border-color: #b85c00;
        color: #ffffff;
    }

    .detail-stock-pill.is-empty,
    .related-stock-pill.is-empty {
        background: #b42318;
        border-color: #b42318;
        color: #ffffff;
    }

    .product-detail-page .related-body .related-stock-pill {
        display: inline-flex;
        width: fit-content;
        align-items: center;
        border: 1px solid transparent;
